---
title: "Mini-entrega 1: Subset-sum problem"
author: "Ignacio Pardo"
description: "Tecnología Digital V: Diseño de algoritmos
...
Dado un multiconjunto (es decir, un conjunto con repeticiones) de números enteros C = {a1, a2, . . . , an} y un número k, el SUBSET-SUM PROBLEM consiste en determinar si existe un subconjunto S $\subseteq$ C tal que la suma de los elementos en S sea k. Por ejemplo, si tenemos como entrada el conjunto C = {2, 2, 5, 10} y k = 9, entonces la respuesta es el multiconjunto S = {2, 2, 5}, cuya suma es 9. En cambio, para k = 11 no hay solución al problema.
